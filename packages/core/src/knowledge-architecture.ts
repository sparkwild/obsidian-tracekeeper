...
export const TRACEKEEPER_AUDIT_DIR = `${TRACEKEEPER_CONTROL_DIR}/audit`;
export const TRACEKEEPER_DASHBOARDS_DIR = `${TRACEKEEPER_CONTROL_DIR}/dashboards`;
export const TRACEKEEPER_AUDIT_LOG_PATH = `${TRACEKEEPER_CONTROL_DIR}/audit_log.md`;
...
export const REQUIRED_KNOWLEDGE_DIRECTORIES = [
