...
exports.TRACEKEEPER_AUDIT_DIR = `${exports.TRACEKEEPER_CONTROL_DIR}/audit`;
...
exports.TRACEKEEPER_AUDIT_LOG_PATH = `${exports.TRACEKEEPER_CONTROL_DIR}/audit_log.md`;
...
exports.YAML_RELATION_KEYS = ['related', 'sources', ...exports.KNW_RELATED_WIKI_KEYS, ...exports.KNW_RELATED_MEMORY_KEYS];
exports.REQUIRED_ARCHITECTURE_ENTRIES = [
    {
