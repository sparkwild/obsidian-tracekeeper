...
exports.toolContracts = [
    ...
    },
    {
        ...
        workflowRole: 'observe',
        useCase: 'read_note',
        description: '[read-only] Read a bounded note window after recall excerpts are insufficient. Defaults to 16384 characters. Follow next_offset with expected_hash when more content is needed; truncated content is not the complete note.',
        inputSchema: withToolInput({
    ...
    },
    {
        ...
        ...withResultSchema(result_schemas_1.REQUEST_MAINTENANCE_OUTPUT_SCHEMA),
    },
    {
