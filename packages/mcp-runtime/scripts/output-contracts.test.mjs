...
function startTaskSuccess() {
	return {
		...
		audit_path: 'Tracekeeper/Audit/start.json',
		vault_root: 'vault',
...
function projectMemorySuccess() {
	return {
		...envelope('tracekeeper.project_memory'),
		read_only: true,
		project_id: 'project-1',
		project_hub: 'Projects/project-1.md',
		generation: 0,
		total: 0,
		counts_by_agent: {},
		complete: true,
		sort: 'created_at_desc_operation_id_path_asc',
...
function finishTaskSuccess() {
	return {
		...
		audit_path: 'Tracekeeper/Audit/finish.json',
	...
	[
		...
		[
			...
			},
			{
				...
				snapshot_warning: null,
				context_pack: contextPack,
				artifact: { path: 'Tracekeeper/Context/q.md', audit_path: 'Tracekeeper/Audit/context.json' },
			},
		],
	],
	[
	...
	[
		...
		[
			...
			},
			{
				...
				target_note: 'Memory/project.md',
				touched_notes: [],
				audit_path: 'Tracekeeper/Audit/apply.json',
			},
		],
	],
	[
		...
		[
			...
			},
			{
				...
				source_note: { path: 'Sources/Notes/source.md', audit_path: 'Tracekeeper/Audit/source-note.json' },
				report: { path: 'Sources/Reports/report.md', audit_path: 'Tracekeeper/Audit/report.json' },
				proposals: [],
				audit_path: 'Tracekeeper/Audit/source-request.json',
				summary: 'summary',
				warnings: [],
			},
		],
		...
		[
			{
				...
				audit_path: 'Tracekeeper/Audit/capture.json',
				warnings: [],
				metadata: { source: 'https://example.test/source', mode: 'external_reference' },
			},
		],
	],
	[
		...
		[
			{
				...
				audit_path: 'Tracekeeper/Audit/propose.json',
				warnings: [],
				auto_applied: true,
				duplicate: false,
