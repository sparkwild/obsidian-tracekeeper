...
function startTaskSuccess() {
	return {
		...
		started_at_source: 'server_observed',
		tracking_started_at: '2026-08-03T01:00:00.000Z',
...
function finishTaskSuccess() {
	return {
		...
		task_id: 'task-finish',
		task_path: '00_tracekeeper/work/tasks/task-finish.md',
		path: '00_tracekeeper/work/tasks/task-finish.md',
		session_path: '00_tracekeeper/work/tasks/task-finish.md',
		activity_path: 'Tracekeeper/AgentActivity/2026-08-03.md',
		tracking_mode: 'live',
		task_record_origin: 'start_task',
		started_at: '2026-08-03T01:00:00.000Z',
...
const successFixtures = new Map([
	...
	[
		...
		[{
			...envelope('tracekeeper.request_maintenance'),
			read_only: false,
			vault_root: 'vault',
			request_id: 'maintenance-request-1',
			request_path: '00_tracekeeper/inbox/agent_requests/maintenance-request-1.md',
			status: 'pending',
			snapshot_generation: 1,
			candidate_ids: ['maintenance_1'],
			task_id: null,
