...
function proposalTransitionReceiptFromStep(
	...
	return {
		...
		kind: 'apply',
		proposalPath: receipt.proposalPath as string,
		proposalId: receipt.proposalId as string,
		taskId: receipt.taskId as string,
		previousStatus: 'approved',
		nextStatus: 'applied',
		expectedRevision: receipt.expectedRevision as string,
		expectedContentHash: receipt.expectedContentHash as string,
