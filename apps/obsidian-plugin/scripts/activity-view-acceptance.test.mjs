...
assert.ok(activityControllerSource.includes('normalizeReviewTargetPath'));
assert.ok(activityControllerSource.includes('instanceof TFile'));
assert.ok(activityControllerSource.includes('blockedReviewQueueItemCount'));
assert.ok(activitySource.includes('需重提 ${snapshot.blockedReviewQueueItemCount}'));
assert.equal(activitySource.includes('· 全部 ${snapshot.reviewQueueItemCount}'), false);
